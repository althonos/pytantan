...
setuptools.setup(
    ext_modules=[
        ExtensionTemplate(
            "pytantan.platform.generic",
            language="c++",
            simd=None,
            include_dirs=["pytantan", os.path.join("vendor", "tantan", "src")],
            templates={
                os.path.join("pytantan", "platform", "generic.pxd"): os.path.join("pytantan", "platform", "pxd.in"),
                os.path.join("pytantan", "platform", "generic.pyx"): os.path.join("pytantan", "platform", "pyx.in"),
            },
            sources=[
        ...
        #     include_dirs=["pytantan", os.path.join("vendor", "tantan", "src")],
        #     templates={
        #         os.path.join("pytantan", "platform", "sse2.pxd"): os.path.join("pytantan", "platform", "pxd.in"),
        #         os.path.join("pytantan", "platform", "sse2.pyx"): os.path.join("pytantan", "platform", "pyx.in"),
        #     },
        #     sources=[
        #         os.path.join("vendor", "tantan", "src", "tantan.cc"),
        #         os.path.join("pytantan", "platform", "sse2.pyx"),
        #     ],
        # ),
        ExtensionTemplate(
            "pytantan.platform.sse4",
            language="c++",
            simd="SSE4",
            define_macros=[("__SSE4_1__", 1)],
            include_dirs=["pytantan", os.path.join("vendor", "tantan", "src")],
            templates={
                os.path.join("pytantan", "platform", "sse4.pxd"): os.path.join("pytantan", "platform", "pxd.in"),
                os.path.join("pytantan", "platform", "sse4.pyx"): os.path.join("pytantan", "platform", "pyx.in"),
            },
            sources=[
                os.path.join("vendor", "tantan", "src", "tantan.cc"),
